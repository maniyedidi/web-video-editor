  ...
  return (
    <div className='flex flex-row p-0 md:p-10 font-sans justify-center bg-[#F0F3F9] h-[100vh]'>
      <div className='hidden md:flex bg-[#2F67CD] w-[50%] rounded-tl-lg rounded-bl-lg text-white  items-center justify-center relative'>
        ...
        ></div>
        <Image className='md:w-[300px] md:h-[240px] lg:w-[500px] lg:h-[400px] p-10' src={LoginLeftImg} />
      </div>
      <div className=' relative flex flex-col items-center bg-white gap-4 w-[100%] md:w-[50%] rounded-tr-lg rounded-br-lg '>
        <div
          className='absolute z-10 w-[120px] md:w-[120px] h-[200px] top-[0px] right-[0px] bg-[#2f67cd] rounded-tl-[50%] rounded-bl-[50%] rounded-tr-[0] rounded-br-[50%]  opacity-[0.4]'         
        ></div>
        <div
        ...
        ></div>
        <Avatar  sx={{ width: 56, height: 56, bgcolor: '#2F67CD', marginTop:10 }}>
          <AcUnitIcon />
        </Avatar>
