...
class WebglController {
  ...
  swapWidthHeight = () => {
    const relX = this.signX / (this.gl.canvas).clientWidth;
    const relY = this.signY / (this.gl.canvas).clientHeight;

    const { width } = this.gl.canvas;
    this.gl.canvas.width = this.gl.canvas.height;
    this.gl.canvas.height = width;

    this.signX = (this.gl.canvas).clientWidth * relX;
    this.signY = (this.gl.canvas).clientHeight * relY;
  };
